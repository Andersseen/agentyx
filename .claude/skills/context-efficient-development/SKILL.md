...
**[.agents/skills/context-efficient-development/SKILL.md](../../../.agents/skills/context-efficient-development/SKILL.md)**

Read that file now and follow it. This file is only the bridge that makes the skill discoverable as
`/context-efficient-development` in Claude Code — never copy the instructions here, and never let
the two drift.
